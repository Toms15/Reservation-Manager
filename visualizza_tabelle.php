...
function periodo_importato ($tariffa,$idperiodo,$dati_tariffe) {
$imp_periodo = 0;
...
return $imp_periodo;
} # fine function periodo_importato
...
$tar_importata[$numtariffa] = periodo_importato('tariffa'.$numtariffa,$idperiodi,$dati_tariffe);
} # fine for $numtariffa
...
$tar_imp = periodo_importato($tariffa,$idperiodi,$dati_tariffe);
